...
class ImportStampsWizard(models.TransientModel):
    ...
    def import_finkokstamps(self):
        ...
        for file in self.file_ids:
            ...
            start = 0 if int(self.year) > 2021 else 9
            cmes = file.name[file.name.find("-",start)+1:]
            #del año 2017 al 2021, el patron: YYYY-MES-
            #del año 2022 al 2024, el patron es: 1. finkok-nombremesini-nombresmes-fin
